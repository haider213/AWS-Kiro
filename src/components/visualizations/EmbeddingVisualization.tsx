      ...
      {embeddings && (
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div className="bg-gray-50 p-2 rounded">
            ...
            <div className="text-gray-600">{embeddings.method}</div>
          </div>
          <div className="bg-gray-50 p-2 rounded">
            <div className="font-medium text-gray-900">Dimensions</div>
            <div className="text-gray-600">{embeddings.dimensions}</div>
          </div>
          <div className="bg-gray-50 p-2 rounded">
          ...
          <div className="bg-gray-50 p-2 rounded">
            ...
            <div className="text-gray-600">{embeddings.model_id}</div>
          </div>
        </div>
      )}
    </div>
